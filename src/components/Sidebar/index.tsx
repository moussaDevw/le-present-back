...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-3 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden rounded-l-3xl bg-white shadow-md duration-300 ease-linear dark:bg-boxdark xl:translate-x-0 ${
      ...
      >
        ...
        <div className="ml-auto mr-auto mt-10">
          <Link href="/">
            <Power className="size-13 text-black" />
          </Link>
