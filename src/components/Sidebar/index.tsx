...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-3 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden rounded-l-3xl bg-white shadow-md duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
